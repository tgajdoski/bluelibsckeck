...
import { DepartmentListFiltersForm } from "../../config/DepartmentListFiltersForm";

type DepartmentsListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const DepartmentsListFilters = React.memo(DepartmentsListFiltersBase);

export function DepartmentsListFiltersBase(props: DepartmentsListFiltersProps) {
  ...
  const filterForm = use(DepartmentListFiltersForm, { transient: true });
  filterForm.build();
